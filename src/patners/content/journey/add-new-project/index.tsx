...
export default function StartNewProjectModal(props: StartProjectProps) {
  ...
  const handleLivestockValueChange = (
      ...
      >
        ...
        <Modal.Body className="modal-body">
          <div
            id="step-one"
            style={
              cropSelected || livestockSelected
                ? { display: "none" }
                : {
                    display: "flex",
                    flexDirection: "column",
              ...
              {({}) => (
                <Form>
                  <div className="modal-input-group">
                    ...
                    <Field placeholder="Maize" type="text" name="cropName" />
                  </div>
