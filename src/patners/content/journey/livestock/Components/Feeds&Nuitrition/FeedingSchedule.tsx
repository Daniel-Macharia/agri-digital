        ...
        >
          {({ setFieldValue, isSubmitting, values, resetForm }) => (
            <Form>
              ...
              {/* Feeding Reminder */}
              <div className="row mb-3 align-items-center">
                <label className="col-md-2 col-form-label d-flex align-self-stretch text-primary-custom body-regular">
                  Feeding Reminder
                </label>
                <div className="col-md-10 d-flex align-items-center">
                  ...
                  <ErrorMessage
                    name="reminder"
                    component="div"
                    className="text-danger small text-start ms-3"
                  />
                </div>
              </div>
              ...
              <style>{`
                .feedingschedule-cancel-btn:hover, .feedingschedule-cancel-btn:focus {
