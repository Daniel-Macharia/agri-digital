      ...
      <div className="row w-100 g-4 mb-3">
        ...
        <div className="col-12 col-md-4 mb-4 mb-md-0">
          <div className="d-flex flex-column align-items-start gap-3 p-4 rounded-4 bg-white h-100 shadow-sm">
            ...
            <div className="w-100">
              <div className="mb-2"><span className="text-secondary">Type</span> <span className="fw-bold float-end">Mechanical</span></div>
              <div><span className="text-secondary">Notes</span> <span className="float-end">--</span></div>
            </div>
          </div>
        </div>
        {/* Space Card */}
        <div className="col-12 col-md-4 mb-4 mb-md-0">
          <div className="d-flex flex-column align-items-start gap-3 p-4 rounded-4 bg-white h-100 shadow-sm">
            ...
            <div className="w-100">
              <div className="mb-2"><span className="text-secondary">Total area in (m²)</span> <span className="fw-bold float-end">15,000m²</span></div>
              <div className="mb-2"><span className="text-secondary">Animal Capacity</span> <span className="fw-bold float-end">15 Cows</span></div>
              <div className="mb-2"><span className="text-secondary">Density</span> <span className="fw-bold float-end">1 cow per 1000m²</span></div>
              <div><span className="text-secondary">Notes</span> <span className="float-end">--</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-4">
          <div className="d-flex flex-column align-items-start gap-3 p-4 rounded-4 bg-white h-100 shadow-sm">
            ...
            <div className="w-100">
              <div className="mb-2"><span className="text-secondary">Disposal Method</span> <span className="fw-bold float-end">Biogas Production</span></div>
              <div className="mb-2"><span className="text-secondary">Frequency</span> <span className="fw-bold float-end">Daily</span></div>
              <div className="mb-2"><span className="text-secondary">Volume</span> <span className="fw-bold float-end">12,000kg</span></div>
              <div><span className="text-secondary">Notes</span> <span className="float-end">--</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="col-12">
          <div className="bg-white rounded-4 p-4 shadow-sm">
            ...
            <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between p-3 rounded-3 border mb-2">
              <div>
                <div className="fw-bold">Livestock Protection Service Request</div>
                <div className="text-secondary" style={{ fontSize: '0.95em' }}>2023/03/07</div>
                <div className="text-secondary" style={{ fontSize: '0.95em' }}>AgriFarm</div>
              </div>
              <button className="btn btn-outline-success px-4 mt-3 mt-md-0">View Report</button>
            </div>
          </div>
        </div>
      </div>
