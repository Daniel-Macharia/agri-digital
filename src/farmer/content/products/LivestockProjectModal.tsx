...
import { LivestockFormData, FormErrors, LivestockProjectModalProps } from './index';

const LivestockProjectModal: React.FC<LivestockProjectModalProps> = ({ show, onHide, onBack, onSubmit }) => {
  ...
  const handleProjectNameChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
   ...
   const handleAnimalTypeChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
              ...
              <Row>
                <Col xs={12}>
                  <Form.Group controlId="animalType" className="mb-4">
                    ...
                    {errors.livestockType && <Form.Text className="text-danger">{errors.livestockType}</Form.Text>}
                  </Form.Group>
                </Col>
              </Row>
