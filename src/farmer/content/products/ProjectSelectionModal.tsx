        ...
        <Row className="justify-content-center">
          <Col xs={12}>
            <div className="text-center mb-3 mb-md-4">
              <div className="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-2 mb-md-3"
              ...
              <p className="text-muted mb-1 small">Ready to start your farming adventure?</p>
