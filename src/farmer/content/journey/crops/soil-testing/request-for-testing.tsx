...
const validationSchema = Yup.object({
  ...
  soilType: Yup.string()
    .required("required")
    .typeError("soil type is required e.g red soil"),
  currentCrop: Yup.string()
    .required("required")
    .typeError("current crop is requied e.g maize, beans"),
  ...
  contactInformation: Yup.string()
    ...
    .test((value) => {
      ...
      return (
        /^0[17]{1}[0-9]{8}$/.test(value) || /^\+254[17]{1}[0-9]{8}$/.test(value)
...
const RequestForTesting: React.FC = () => {
  ...
  const handleRequestForTesting = useCallback(
    (data: RequestForTestingProps, {}: any) => {
        ...
        <div className="row justify-content-start">
          <div className="col-2 col-md-1 px-0 mx-0">
            <div className="row justify-content-start px-0 mx-0">
              <img src="/assets/images/back-icon.svg" onClick={goBack} />
            </div>
          </div>
        </div>
