    ...
    <div className="container p-4">
          ...
          <Card className="h-100">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-start">
                <Card.Title as="h3" className="h3-bold mb-2">
                  Ventilation
                </Card.Title>
        ...
        <div className="col-md-4">
          <Card className="h-100">
            <Card.Body>
              ...
              <div className="d-flex justify-content-between">
                <small className="text-muted">Total area in (m²)</small>
                <small className="fw-bold">15,000m²</small>
              </div>
              <div className="d-flex justify-content-between">
                <small className="text-muted">Animal Capacity</small>
                <small className="fw-bold">15 Cows</small>
              </div>
              <div className="d-flex justify-content-between">
                <small className="text-muted">Density</small>
                <small className="fw-bold">1 cow per 1000m²</small>
              </div>
              <div className="d-flex justify-content-between">
                <small className="text-muted">Notes</small>
                <small className="fw-bold">--</small>
        ...
        <div className="col-md-4">
          <Card className="h-100">
            <Card.Body>
              ...
              <div className="d-flex justify-content-between">
                <small className="text-muted">Disposal Method</small>
                <small className="fw-bold">Biogas Production</small>
              </div>
              <div className="d-flex justify-content-between">
                <small className="text-muted">Frequency</small>
                <small className="fw-bold">Daily</small>
              </div>
              <div className="d-flex justify-content-between">
                <small className="text-muted">Volume</small>
                <small className="fw-bold">12,000kg</small>
              </div>
              <div className="d-flex justify-content-between">
                <small className="text-muted">Notes</small>
                <small className="fw-bold">--</small>
      ...
      <div className="row mb-4">
        <div className="col-md-6">
          <Card className="h-100">
            <Card.Body>
              <Card.Title as="h6" className="mb-3 h3-semibold">
                Add New Activity
              </Card.Title>
              <Form
                onSubmit={(e) => {
              ...
              >
                ...
                <Button
                  ...
                  type="submit"
                  className="w-lg-25"
                  style={{ backgroundColor: "var(--Primary, #457900)" }}
                >
                  Add Activity
                </Button>
              </Form>
          ...
          <Card className="h-100">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center mb-3">
                <Card.Title as="h6" className="mb-0 h3-semibold">
                  Upcoming Activities
                </Card.Title>
              </div>
              <Card className="mb-3">
