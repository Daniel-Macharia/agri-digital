...
const PolicyPayment: React.FC<PaymentPageProps> = ({ 
    onPaymentSuccess, 
    total,
    title = "Payment",
    description,
                    ...
                    <Card className="shadow-sm">
                        <Card.Header className="bg-white border-0 pt-4 pb-0">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <Button 
                                    ...
                                    className="cancel-btn bg-white border-0 border-transparent"
                                >
                                  <FiX/>
                                </Button>
                            </div>
                        ...
                        <Card.Body className="pt-3">
                            <div className="text-center mb-4">
                                <h5 className="payment-amount text-start">
                            ...
                            {selectedPayment && (
                                <div className="d-grid gap-2 mt-4">
                                    <Button 
                                        ...
                                        className="process-payment-btn col-6"
                                        size="sm"
                                    >
                                        Process Payment
                                    </Button>
