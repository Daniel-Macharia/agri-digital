    ...
    return (
      <>
        <div className="col-12 farmer-home-container">
          <div
            className="farmer-home-container p-4 mx-0 col-12"
            style={{ backgroundColor: "whitesmoke" }}
          >
            <p className="body-semibold secondary-text">{data.projectName}</p>

            <div className=" my-3">
              <p
                className=" mb-0 small-regular primary-text"
              ...
              backColor="var(--cards-form-bg, #FFF)"
              />
            </div>
